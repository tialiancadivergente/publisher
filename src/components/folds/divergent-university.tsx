...
export function DivergentUniversitySection() {
  return (
    <section
      ...
      role="region"
    >
      <div className="container flex flex-col items-center justify-center gap-10 mb-20 font-mulish text-center">
        <h2 id="universidade-divergente-heading" className="sr-only">
        ...
        <Reveal delay={140}>
          <p
            className="text-[18px]/[32px] font-light text-white text-center"
            tabIndex={0}
          >
