				...
				<div className="w-full 2md:max-w-[528px] max-w-[440px]">
					...
					<div className="max-w-lg">
						<LeadCaptureForm
							...
							phoneInputClassName="w-full !h-[58px] px-4 py-4 rounded-r-[8px] rounded-l-[0px] bg-[#FFFFFF26] text-[#07242C] focus:outline-none h-[53px] border border-[#FBFBFB] border-l-[0px] placeholder:text-[#07242C]"
